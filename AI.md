...
hello-world-python is a simple Python project template and demonstration.
...
- Provide clear instructions for customization and extension.
- Use standard Python project organization (e.g., `src/`, `tests/`).
